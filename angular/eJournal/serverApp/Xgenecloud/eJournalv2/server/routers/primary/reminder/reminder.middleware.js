...
class ReminderMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./reminder.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./reminder.policy').acl);
  }


  async default (req, res, next) {

    console.log('Reminder middleware;')
...
module.exports = ReminderMiddleware;