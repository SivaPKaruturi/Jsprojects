...
class GratitudeMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./gratitude.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./gratitude.policy').acl);
  }


  async default (req, res, next) {

    console.log('Gratitude middleware;')
...
module.exports = GratitudeMiddleware;